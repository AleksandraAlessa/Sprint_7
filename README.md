...
Из 15 тестов 14 прошли проверку Passed, 1 тест - Failed:
Тест на отсутствие поля password при логине может возвращать 504 Gateway Timeout вместо 400 – это баг
